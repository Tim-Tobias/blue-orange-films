...
const IntroduceLayout = ({ imgUrl, title }: IntroduceLayoutProps) => {
    return (
        <AppFrontContainer>
            ...
            <div className="absolute top-0 left-0 h-[80vh] w-full bg-black opacity-40" />

            <div className="relative grid h-full w-full grid-cols-1 place-items-center">
                <h1 data-aos="fade-right" data-aos-delay="600" className="text-5xl font-semibold text-white">
                    {title}
                </h1>
            </div>
        </AppFrontContainer>
